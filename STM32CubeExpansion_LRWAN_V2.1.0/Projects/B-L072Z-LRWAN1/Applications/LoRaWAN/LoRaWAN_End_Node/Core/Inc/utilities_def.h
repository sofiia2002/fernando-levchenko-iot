...
typedef enum
{
  ...
  CFG_SEQ_Task_LoRaSendOnTemperatureTimerEvent,
  CFG_SEQ_Task_LoRaSendOnPressureTimerEvent,
  CFG_SEQ_Task_LoRaSendOnHumidityTimerEvent,
  /* USER CODE BEGIN CFG_SEQ_Task_Id_t */
  CFG_SEQ_Task_CollectMeasurmentsEvent,
